...
🚀 Uso
Editar $rootPath en el script con la ruta deseada

Ejecutar con PowerShell: .\configurar-vistas.ps1

Si hay error de permisos ejecutar: Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser
...
🚀 Usage
Edit $rootPath in the script with your desired path

Run with PowerShell: .\configure-views.ps1

If permission error occurs, run: Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope CurrentUser
